...
* Asakusa Framework 0.10.4 を推奨バージョンに変更

..  attention::
    同梱のソフトウェアに対する動作検証などの理由により、 本バージョン以降では **インストールするAsakusa Frameworkのバージョンは 0.10.4 以降に指定することを強く推奨します。**
...
* Asakusa Framework 0.10.3 を推奨バージョンに変更

..  attention::
    同梱のソフトウェアに対する動作検証などの理由により、 本バージョン以降では **インストールするAsakusa Frameworkのバージョンは 0.10.3 以降に指定することを強く推奨します。**
...
* Asakusa Framework 0.10.2 を推奨バージョンに変更

..  attention::
    同梱のソフトウェアに対する動作検証などの理由により、 本バージョン以降では **インストールするAsakusa Frameworkのバージョンは 0.10.2 以降に指定することを強く推奨します。**
...
* Asakusa Framework 0.10.1 を推奨バージョンに変更
* 同梱するApache Sparkのバージョンを 2.3.1 にアップデート
* 同梱するEclipseのバージョンを 4.8.0 にアップデート
* 対応プラットフォームの改訂 - Ubuntu のバージョンを18.04にアップデート、およびCentOSを削除
* Shafuのドキュメントを改訂 - Shafu バージョン 0.7.0 時点の機能を反映

..  attention::
    同梱のソフトウェアに対する動作検証などの理由により、 本バージョン以降では **インストールするAsakusa Frameworkのバージョンは 0.10.1 以降に指定することを強く推奨します。**
