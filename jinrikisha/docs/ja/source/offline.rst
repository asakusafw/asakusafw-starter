...
アプリケーション開発プロジェクトの作成
--------------------------------------
新規でアプリケーション開発プロジェクトを作成する場合、通常は `Asakusa Gradle Plugin利用ガイド`_ に従い、Asakusa Frameworkが公開しているプロジェクトテンプレートを使用します。このテンプレートファイルをあらかじめ開発環境に配置しておけば、オフライン環境で新規プロジェクトを作成することができます。
